...
const BOOSTERS = [
  ...
  },
  {
    ...
    emoji: "⚡",
    name: "PowerSpin",
    desc: "В случае проигрыша игроку даётся ещё одно дополнительное вращение барабана что увеличивает шанс на победу",
    cost: 200,
    color: "#7c4dff",
  },
  {
    ...
    emoji: "🎁",
    name: "BonusDrum",
    desc: "Активируется бонусный барабан с помощью которого игрок сможет выиграть дополнительный гарантированный приз",
    cost: 100,
    color: "#00bcd4",
  },
];
